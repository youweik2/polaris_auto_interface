            ...
            for k, alpha in enumerate(self.alphas):
                ...
                for t in range(N):
                    ...
                    if control_bounds is not None:
                        U_star[t, 0] = np.clip(U_star[t, 0], control_bounds['v_min'], control_bounds['v_max'])
                        U_star[t, 1] = np.clip(U_star[t, 1], control_bounds['omega_min'], control_bounds['omega_max'])
