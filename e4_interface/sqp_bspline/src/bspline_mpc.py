...
from b_mpc.bsplineMPC1 import GemCarOptimizer
from b_mpc.bsplineMPC1 import GemCarModel
...
class VehicleController():
    ...
    def start_loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.mpc_interface(self.curr_x, self.curr_y, self.angle, self.fai, self.speed, self.acc, self.omega)
            self.rate.sleep()
