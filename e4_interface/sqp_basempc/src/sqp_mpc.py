...
from ros1_mpc.BaseMPC import GemCarModel
...
class VehicleController():
    ...
    def start_loop(self):
        ...
        x_init, y_init, theta_init, vel_init = self.curr_x, self.curr_y, self.curr_yaw, 0.0
        ...
        while not rospy.is_shutdown():
            ...
            self.mpc_interface(self.curr_x, self.curr_y, self.angle, self.speed,  self.acc, self.fai)
            self.rate.sleep()
    ...
    def mpc_interface(self, x_real, y_real, theta_real, vel_real, a_real, fai_real):
        ...
        # Solve !!!
        x_1, y_1, theta_1, vel_1, a_1, o_1 = self.opt.solve(x_real, y_real, theta_real, vel_real, a_real, fai_real)
